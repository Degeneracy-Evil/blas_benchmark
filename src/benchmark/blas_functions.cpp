...
template <typename T>
std::vector<T> generate_random_data(std::size_t size, T min_val = static_cast<T>(-1.0),
                      ...
                      std::size_t cycles, bool flush_cache, std::size_t cache_size)
{
    ...
    for(std::size_t i = 0; i < warmup; ++i)
    {
        ...
        BlasWrapper<T>::gemm(CblasRowMajor, CblasNoTrans, CblasNoTrans, m, n, k, alpha, a.data(),
                             static_cast<int>(k), b.data(), static_cast<int>(n), beta, c.data(),
                             static_cast<int>(n));
    }
...
template double benchmark_scal<double>(std::size_t n, std::size_t warmup, std::size_t cycles,
                                       bool flush_cache, std::size_t cache_size);
template double benchmark_gemv<double>(std::size_t m, std::size_t n, std::size_t warmup,
                                       std::size_t cycles, bool flush_cache,
                                       std::size_t cache_size);
template double benchmark_gemm<double>(std::size_t m, std::size_t n, std::size_t k,
                                       std::size_t warmup, std::size_t cycles, bool flush_cache,
                                       std::size_t cache_size);
